            ...
            <div className="row mb-5">
              ...
              <div className="col-md-6">
                <div className="">
                  ...
                  <h3 >
                    If you are an artisian and don't know how to sell your products,
                  </h3>
              ...
              <div className="col-md-6">
                <div className="">
                  ...
                  they embody the essence of creativity and commitment,
                   mirroring the artists' path and the principles they champion.
                  </h3>
                  <h2 className="text-center" style={{ color: currentColor }}>
                    We are the gate to special items ...
                  </h2>
                  <h3>
                    If you are a customer and looking for unique items, you are in the right place.
                  </h3>
                  <h3>Hurry up and join us.</h3>
                </div>
                {userData ? "" : (
        ...
        <div className="row g-4 py-5">
            ...
            <div className="col-lg-4 col-md-6">
                <div className={`${styles.servitem} text-center bg-white shadow-lg rounded-2 p-4`}>
                    ...
                    <p className="text-muted"> A wide range of unique items and all of louts items are handmade with love!</p>
                </div>
            </div>
            ...
            <div className={`${styles.servitem} text-center bg-white shadow-lg rounded-2 p-4`}>
                ...
                <i className="fa fa-umbrella"></i>
                    ...
                    <p className="text-muted">Look for consistency in the quality of our products. High-quality materials, attention to details!</p>
                </div>
            </div>
            ...
            <div className={`${styles.servitem} text-center bg-white shadow-lg rounded-2 p-4`}>
                ...
                <i className="fa fa-diamond"></i>
                    ...
                    <p className="text-muted">Trusted artisans communicate professionally. We also offer guarantees for our products.</p>
                </div>
            </div>
            ...
            <div className={`${styles.servitem} text-center bg-white shadow-lg rounded-2 p-4`}>
                ...
                <i className="fa fa-television"></i>
                    ...
                    <p className="text-muted">Limited-time offers and flash sales. These exclusive promotions give you an opportunity to save more on your favorite items.  </p>
                </div>
            </div>
